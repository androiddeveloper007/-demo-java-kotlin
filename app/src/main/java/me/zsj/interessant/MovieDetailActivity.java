...
public class MovieDetailActivity extends RxAppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        replyApi = RetrofitFactory.Companion.getRetrofit().createApi(ReplyApi.class);
    ...
    private void loadReplies(boolean clean) {
        ...
        if (clean)
            result = replyApi.fetchReplies(item.data.id);
        else
            result = replyApi.fetchReplies(item.data.id, lastId);
